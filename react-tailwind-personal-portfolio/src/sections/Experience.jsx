                  ...
                  >
                    {exp.certificateLink && (
                      <a
                        ...
                        className="absolute top-4 left-4 p-2 rounded-full bg-surface hover:bg-primary/20 border border-primary/30 hover:border-primary/60 transition-all duration-300 group"
