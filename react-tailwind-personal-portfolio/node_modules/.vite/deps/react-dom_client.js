import { n as __commonJS, t as require_react } from "./react-DNAz5D67.js";
import { t as require_react_dom } from "./react-dom-DCccd8BM.js";
...
var require_react_dom_client_development = /* @__PURE__ */ __commonJS({ "node_modules/react-dom/cjs/react-dom-client.development.js": ((exports) => {
	(function() {
		...
		function getLowestCommonAncestor(instA, instB, getParent$1) {
			for (var depthA = 0, tempA = instA; tempA; tempA = getParent$1(tempA)) depthA++;
			tempA = 0;
			for (var tempB = instB; tempB; tempB = getParent$1(tempB)) tempA++;
			for (; 0 < depthA - tempA;) instA = getParent$1(instA), depthA--;
			for (; 0 < tempA - depthA;) instB = getParent$1(instB), tempA--;
			for (; depthA--;) {
		...
		function getEntangledLanes(root$1, renderLanes$1) {
			0 !== (renderLanes$1 & 8) && (renderLanes$1 |= renderLanes$1 & 32);
			var allEntangledLanes = root$1.entangledLanes;
			if (0 !== allEntangledLanes) for (root$1 = root$1.entanglements, allEntangledLanes &= renderLanes$1; 0 < allEntangledLanes;) {
				var index = 31 - clz32(allEntangledLanes), lane = 1 << index;
				renderLanes$1 |= root$1[index];
		...
		function addObjectToProperties(object, properties, indent, prefix$1) {
			if (!ArrayBuffer.isView(object)) {
				...
				for (key in object) if (hasOwnProperty.call(object, key) && "_" !== key[0] && (addedProperties++, addValueToProperties(key, object[key], properties, indent, prefix$1), addedProperties >= OBJECT_WIDTH_LIMIT)) {
					properties.push([prefix$1 + "\xA0\xA0".repeat(indent) + "Only " + OBJECT_WIDTH_LIMIT + " properties are shown. React will not log more properties of this object.", ""]);
					break;
				}
			}
		}
			...
			switch (typeof value) {
				case "object": if (null === value) {
					...
					if (readReactElementTypeof(value) === REACT_ELEMENT_TYPE) {
						...
						propertyName = !1;
						key = 0;
						for (var propKey in value) if (key++, "children" === propKey ? null != value.children && (!isArrayImpl(value.children) || 0 < value.children.length) && (propertyName = !0) : hasOwnProperty.call(value, propKey) && "_" !== propKey[0] && addValueToProperties(propKey, value[propKey], properties, indent + 1, prefix$1), key >= OBJECT_WIDTH_LIMIT) break;
					...
					if (ArrayBuffer.isView(value)) {
						value = value.length;
						value = "number" === typeof value ? typeName$1 + "(" + value + ")" : typeName$1;
						break;
					}
					if ("Array" === typeName$1) {
						if (propKey = value.length > OBJECT_WIDTH_LIMIT, key = getArrayKind(value), key === PRIMITIVE_ARRAY || key === EMPTY_ARRAY) {
							...
							for (propertyName = 0; propertyName < value.length && propertyName < OBJECT_WIDTH_LIMIT; propertyName++) typeName$1 = value[propertyName], addValueToProperties(typeName$1[0], typeName$1[1], properties, indent + 1, prefix$1);
							propKey && addValueToProperties(OBJECT_WIDTH_LIMIT.toString(), "…", properties, indent + 1, prefix$1);
							return;
						}
					}
		...
		function createWorkInProgress(current$1, pendingProps) {
			...
			workInProgress$1.flags = current$1.flags & 1206910976;
			...
			switch (workInProgress$1.tag) {
				...
				case 14:
				case 1:
				case 11: workInProgress$1.type = resolveTypeForHotReloading(current$1.type);
			}
			return workInProgress$1;
		}
		function resetWorkInProgress(workInProgress$1, renderLanes$1) {
			workInProgress$1.flags &= 1206910978;
		...
		function propagateContextChanges(workInProgress$1, contexts, renderLanes$1, forcePropagateEntireTree) {
			...
			for (; null !== fiber;) {
				...
				if (null !== list) {
					...
					nextFiber = null;
				} else 13 === fiber.tag && null !== fiber.memoizedState && null === fiber.memoizedState.dehydrated ? (fiber.lanes |= renderLanes$1, nextFiber = fiber.alternate, null !== nextFiber && (nextFiber.lanes |= renderLanes$1), scheduleContextWorkOnParentPath(fiber.return, renderLanes$1, workInProgress$1), nextFiber = fiber.child, nextFiber = null !== nextFiber ? nextFiber.sibling : null) : nextFiber = fiber.child;
		...
		function queueTransitionTypes(root$1, transitionTypes) {
			if (0 !== (root$1.pendingLanes & 4194048)) {
				var queued = root$1.transitionTypes;
				null === queued && (queued = root$1.transitionTypes = []);
				for (root$1 = 0; root$1 < transitionTypes.length; root$1++) {
					var transitionType = transitionTypes[root$1];
					-1 === queued.indexOf(transitionType) && queued.push(transitionType);
				}
			}
		}
		function claimQueuedTransitionTypes(root$1) {
			var claimed = root$1.transitionTypes;
			root$1.transitionTypes = null;
			return claimed;
		}
		...
		function trackUsedThenable(thenableState$2, thenable, index, fiber) {
		...
		function createChildReconciler(shouldTrackSideEffects) {
			...
			function updateElement(returnFiber, current$1, element, lanes) {
				...
				if (elementType === REACT_FRAGMENT_TYPE) return current$1 = updateFragment(returnFiber, current$1, element.props.children, lanes, element.key), coerceRef(current$1, element), validateFragmentProps(element, current$1, returnFiber), current$1;
		...
		function finishRenderingHooks(current$1, workInProgress$1) {
			...
			null !== lastSuspendedFiber && areSameKeyPath(lastSuspendedFiber, workInProgress$1) && (null !== thenableState$jscomp$0 || null === lastSuspendedStack || didIssueUseWarning || (didIssueUseWarning = !0, console.error(lastSuspendedStack)), lastSuspendedStack = lastSuspendedFiber = null);
			ReactSharedInternals.H = ContextOnlyDispatcher;
			thenableState$jscomp$0 = null !== currentHook && null !== currentHook.next;
			renderLanes = 0;
			hookTypesDev = currentHookNameInDev = workInProgressHook = currentHook = currentlyRenderingFiber = null;
			hookTypesUpdateIndexDev = -1;
			null !== current$1 && (current$1.flags & 1206910976) !== (workInProgress$1.flags & 1206910976) && console.error("Internal React error: Expected static flag was missing. Please notify the React team.");
		...
		function bailoutHooks(current$1, workInProgress$1, lanes) {
			workInProgress$1.updateQueue = current$1.updateQueue;
			workInProgress$1.flags = (workInProgress$1.mode & StrictEffectsMode) !== NoMode ? workInProgress$1.flags & -805308421 : workInProgress$1.flags & -2053;
		...
		function updateForwardRef(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			...
			resolvedRender !== Component && (Component = resolvedRender, null !== current$1 && (didReceiveUpdate = !0));
			resolvedRender = workInProgress$1.ref;
			if ("ref" in nextProps) {
				var propsWithoutRef = {};
				for (var key in nextProps) "ref" !== key && (propsWithoutRef[key] = nextProps[key]);
			} else propsWithoutRef = nextProps;
			prepareToReadContext(workInProgress$1);
			nextProps = renderWithHooks(current$1, workInProgress$1, Component, propsWithoutRef, resolvedRender, renderLanes$1);
		...
		function updateMemoComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			if (null === current$1) {
				...
				if ("function" === typeof type && !shouldConstruct(type) && void 0 === type.defaultProps && null === Component.compare) return Component = resolveTypeForHotReloading(type), workInProgress$1.tag = 15, workInProgress$1.type = Component, validateFunctionComponentInDev(workInProgress$1, type), updateSimpleMemoComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1);
		...
		function updateActivityComponent(current$1, workInProgress$1, renderLanes$1) {
			...
			if (null === current$1) {
				if (isHydrating) {
					if ("hidden" === nextProps.mode) return current$1 = mountActivityChildren(workInProgress$1, nextProps), workInProgress$1.lanes = 536870912, current$1.memoizedState = {
						baseLanes: 0,
						cachePool: null
					}, bailoutOffscreenComponent(null, current$1);
		...
		function updateClassComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			...
			if (null === workInProgress$1.stateNode) {
				...
				(workInProgress$1.mode & StrictEffectsMode) !== NoMode && (workInProgress$1.flags |= 268435456);
				_instance = !0;
				...
				unresolvedOldProps || oldState !== oldContext || hasForceUpdate ? ("function" === typeof newApiName && (applyDerivedStateFromProps(workInProgress$1, Component, newApiName, nextProps), oldContext = workInProgress$1.memoizedState), (lane = hasForceUpdate || checkShouldComponentUpdate(workInProgress$1, Component, lane, nextProps, oldState, oldContext, state)) ? (foundWillUpdateName || "function" !== typeof _instance.UNSAFE_componentWillMount && "function" !== typeof _instance.componentWillMount || ("function" === typeof _instance.componentWillMount && _instance.componentWillMount(), "function" === typeof _instance.UNSAFE_componentWillMount && _instance.UNSAFE_componentWillMount()), "function" === typeof _instance.componentDidMount && (workInProgress$1.flags |= 4194308), (workInProgress$1.mode & StrictEffectsMode) !== NoMode && (workInProgress$1.flags |= 268435456)) : ("function" === typeof _instance.componentDidMount && (workInProgress$1.flags |= 4194308), (workInProgress$1.mode & StrictEffectsMode) !== NoMode && (workInProgress$1.flags |= 268435456), workInProgress$1.memoizedProps = nextProps, workInProgress$1.memoizedState = oldContext), _instance.props = nextProps, _instance.state = oldContext, _instance.context = state, _instance = lane) : ("function" === typeof _instance.componentDidMount && (workInProgress$1.flags |= 4194308), (workInProgress$1.mode & StrictEffectsMode) !== NoMode && (workInProgress$1.flags |= 268435456), _instance = !1);
			} else {
				_instance = workInProgress$1.stateNode;
		...
		function updateSuspenseComponent(current$1, workInProgress$1, renderLanes$1) {
			...
			if (null === current$1) {
				if (isHydrating) {
					...
					(current$1 = nextHydratableInstance) ? (renderLanes$1 = canHydrateHydrationBoundary(current$1, rootOrSingletonContext), renderLanes$1 = null !== renderLanes$1 && renderLanes$1.data !== ACTIVITY_START_DATA ? renderLanes$1 : null, null !== renderLanes$1 && (JSCompiler_temp = {
						dehydrated: renderLanes$1,
						treeContext: getSuspendedTreeContext(),
						retryLane: 536870912,
						hydrationErrors: null
				...
				if (showFallback) return reuseSuspenseHandlerOnStack(workInProgress$1), showFallback = workInProgress$1.mode, didSuspend = mountWorkInProgressOffscreenFiber({
					mode: "hidden",
					children: didSuspend
				}, showFallback), nextProps = createFiberFromFragment(nextProps, showFallback, renderLanes$1, null), didSuspend.return = workInProgress$1, nextProps.return = workInProgress$1, didSuspend.sibling = nextProps, workInProgress$1.child = didSuspend, nextProps = workInProgress$1.child, nextProps.memoizedState = mountSuspenseOffscreenState(renderLanes$1), nextProps.childLanes = getRemainingWorkInPrimaryTree(current$1, JSCompiler_temp, renderLanes$1), workInProgress$1.memoizedState = SUSPENDED_MARKER, bailoutOffscreenComponent(null, nextProps);
				pushPrimaryTreeSuspenseHandler(workInProgress$1);
				return mountSuspensePrimaryChildren(workInProgress$1, didSuspend);
			}
			var prevState = current$1.memoizedState;
			if (null !== prevState) {
				var _dehydrated2 = prevState.dehydrated;
				if (null !== _dehydrated2) return updateDehydratedSuspenseComponent(current$1, workInProgress$1, didSuspend, JSCompiler_temp, nextProps, _dehydrated2, prevState, renderLanes$1);
			}
			if (showFallback) return reuseSuspenseHandlerOnStack(workInProgress$1), showFallback = nextProps.fallback, didSuspend = workInProgress$1.mode, prevState = current$1.child, _dehydrated2 = prevState.sibling, nextProps = createWorkInProgress(prevState, {
				mode: "hidden",
				children: nextProps.children
			}), nextProps.subtreeFlags = prevState.subtreeFlags & 1206910976, null !== _dehydrated2 ? showFallback = createWorkInProgress(_dehydrated2, showFallback) : (showFallback = createFiberFromFragment(showFallback, didSuspend, renderLanes$1, null), showFallback.flags |= 2), showFallback.return = workInProgress$1, nextProps.return = workInProgress$1, nextProps.sibling = showFallback, workInProgress$1.child = nextProps, bailoutOffscreenComponent(null, nextProps), nextProps = workInProgress$1.child, showFallback = current$1.child.memoizedState, null === showFallback ? showFallback = mountSuspenseOffscreenState(renderLanes$1) : (didSuspend = showFallback.cachePool, null !== didSuspend ? (prevState = CacheContext._currentValue, didSuspend = didSuspend.parent !== prevState ? {
				parent: prevState,
				pool: prevState
			} : didSuspend) : didSuspend = getSuspendedCache(), showFallback = {
				baseLanes: showFallback.baseLanes | renderLanes$1,
				cachePool: didSuspend
			}), nextProps.memoizedState = showFallback, nextProps.childLanes = getRemainingWorkInPrimaryTree(current$1, JSCompiler_temp, renderLanes$1), workInProgress$1.memoizedState = SUSPENDED_MARKER, bailoutOffscreenComponent(current$1.child, nextProps);
		...
		function updateDehydratedSuspenseComponent(current$1, workInProgress$1, didSuspend, didPrimaryChildrenDefer, nextProps, suspenseInstance, suspenseState, renderLanes$1) {
			if (didSuspend) {
				if (workInProgress$1.flags & 256) return pushPrimaryTreeSuspenseHandler(workInProgress$1), workInProgress$1.flags &= -257, retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1);
				if (null !== workInProgress$1.memoizedState) return reuseSuspenseHandlerOnStack(workInProgress$1), workInProgress$1.child = current$1.child, workInProgress$1.flags |= 128, null;
				reuseSuspenseHandlerOnStack(workInProgress$1);
				var fallbackChildren = nextProps.fallback, fiberMode = workInProgress$1.mode, primaryChildFragment = mountWorkInProgressOffscreenFiber({
					mode: "visible",
					children: nextProps.children
				}, fiberMode);
				fallbackChildren = createFiberFromFragment(fallbackChildren, fiberMode, renderLanes$1, null);
				fallbackChildren.flags |= 2;
				primaryChildFragment.return = workInProgress$1;
				fallbackChildren.return = workInProgress$1;
				primaryChildFragment.sibling = fallbackChildren;
				workInProgress$1.child = primaryChildFragment;
				reconcileChildFibers(workInProgress$1, current$1.child, null, renderLanes$1);
				fallbackChildren = workInProgress$1.child;
				fallbackChildren.memoizedState = mountSuspenseOffscreenState(renderLanes$1);
				fallbackChildren.childLanes = getRemainingWorkInPrimaryTree(current$1, didPrimaryChildrenDefer, renderLanes$1);
				workInProgress$1.memoizedState = SUSPENDED_MARKER;
				return bailoutOffscreenComponent(null, fallbackChildren);
			}
			pushPrimaryTreeSuspenseHandler(workInProgress$1);
			warnIfHydrating();
			0 !== (renderLanes$1 & 536870912) && markRenderDerivedCause(workInProgress$1);
			if (isSuspenseInstanceFallback(suspenseInstance)) {
				...
				return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1);
			}
			didReceiveUpdate || propagateParentContextChanges(current$1, workInProgress$1, renderLanes$1, !1);
			didPrimaryChildrenDefer = 0 !== (renderLanes$1 & current$1.childLanes);
			if (didReceiveUpdate || didPrimaryChildrenDefer) {
				if (null !== currentTreeHiddenStackCursor.current) return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1);
				didPrimaryChildrenDefer = workInProgressRoot;
				if (null !== didPrimaryChildrenDefer && (fallbackChildren = getBumpedLaneForHydration(didPrimaryChildrenDefer, renderLanes$1), 0 !== fallbackChildren && fallbackChildren !== suspenseState.retryLane)) throw suspenseState.retryLane = fallbackChildren, enqueueConcurrentRenderForLane(current$1, fallbackChildren), scheduleUpdateOnFiber(didPrimaryChildrenDefer, current$1, fallbackChildren), SelectiveHydrationException;
				isSuspenseInstancePending(suspenseInstance) || renderDidSuspendDelayIfPossible();
				return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1);
			}
			if (isSuspenseInstancePending(suspenseInstance)) return workInProgress$1.flags |= 192, workInProgress$1.child = current$1.child, null;
			current$1 = suspenseState.treeContext;
			...
			hydrationDiffRootDEV = null;
			rootOrSingletonContext = !1;
			null !== current$1 && restoreSuspendedTreeContext(workInProgress$1, current$1);
			workInProgress$1 = mountSuspensePrimaryChildren(workInProgress$1, nextProps.children);
			workInProgress$1.flags |= 134221824;
			return workInProgress$1;
		}
		...
		function updateSuspenseListComponent(current$1, workInProgress$1, renderLanes$1) {
			...
			if (workInProgress$1.flags & 128) return pushSuspenseListContext(workInProgress$1, suspenseContext), null;
			...
			pushSuspenseListContext(workInProgress$1, suspenseContext);
			...
			"backwards" === revealOrder && null !== current$1 ? (reverseChildren(current$1), reconcileChildren(current$1, workInProgress$1, newChildren, renderLanes$1), reverseChildren(current$1)) : reconcileChildren(current$1, workInProgress$1, newChildren, renderLanes$1);
			...
			switch (revealOrder) {
				case "backwards":
					renderLanes$1 = findLastContentRow(workInProgress$1.child);
					null === renderLanes$1 ? (revealOrder = workInProgress$1.child, workInProgress$1.child = null) : (revealOrder = renderLanes$1.sibling, renderLanes$1.sibling = null, reverseChildren(workInProgress$1));
					initSuspenseListRenderState(workInProgress$1, !0, revealOrder, null, tailMode, newChildren);
					break;
				...
				case "independent":
					workInProgress$1.memoizedState = null;
					break;
				default: renderLanes$1 = findLastContentRow(workInProgress$1.child), null === renderLanes$1 ? (revealOrder = workInProgress$1.child, workInProgress$1.child = null) : (revealOrder = renderLanes$1.sibling, renderLanes$1.sibling = null), initSuspenseListRenderState(workInProgress$1, !1, revealOrder, renderLanes$1, tailMode, newChildren);
			}
			return workInProgress$1.child;
		}
		function updateContextProvider(current$1, workInProgress$1, renderLanes$1) {
			var context = workInProgress$1.type, newProps = workInProgress$1.pendingProps, newValue = newProps.value;
			...
			reconcileChildren(current$1, workInProgress$1, newProps.children, renderLanes$1);
			return workInProgress$1.child;
		}
			...
			switch (workInProgress$1.tag) {
				...
				case 13:
					...
					if (null !== stateNode) {
						...
						stateNode = propagateParentContextChanges(current$1, workInProgress$1, renderLanes$1, !1);
						var primaryChildLanes = workInProgress$1.child.childLanes;
						if (stateNode || 0 !== (renderLanes$1 & primaryChildLanes)) return updateSuspenseComponent(current$1, workInProgress$1, renderLanes$1);
						pushPrimaryTreeSuspenseHandler(workInProgress$1);
					...
					break;
				case 19:
					if (workInProgress$1.flags & 128) return updateSuspenseListComponent(current$1, workInProgress$1, renderLanes$1);
					primaryChildLanes = 0 !== (current$1.flags & 128);
		...
		function beginWork(current$1, workInProgress$1, renderLanes$1) {
			if (workInProgress$1._debugNeedsRemount && null !== current$1) {
				renderLanes$1 = createFiberFromTypeAndProps(resolveTypeForHotReloading(workInProgress$1.elementType), workInProgress$1.key, workInProgress$1.pendingProps, workInProgress$1._debugOwner || null, workInProgress$1.mode, workInProgress$1.lanes);
			...
			switch (workInProgress$1.tag) {
					...
					a: if (returnFiber = workInProgress$1.pendingProps, current$1 = resolveLazy(workInProgress$1.elementType), current$1 = resolveTypeForHotReloading(current$1), workInProgress$1.type = current$1, "function" === typeof current$1) shouldConstruct(current$1) ? (returnFiber = resolveClassComponentProps(current$1, returnFiber), workInProgress$1.tag = 1, workInProgress$1 = updateClassComponent(null, workInProgress$1, current$1, returnFiber, renderLanes$1)) : (workInProgress$1.tag = 0, validateFunctionComponentInDev(workInProgress$1, current$1), workInProgress$1 = updateFunctionComponent(null, workInProgress$1, current$1, returnFiber, renderLanes$1));
						...
						if (void 0 !== current$1 && null !== current$1) {
							if (prevSibling = current$1.$$typeof, prevSibling === REACT_FORWARD_REF_TYPE) {
								...
								workInProgress$1.tag = 10;
								workInProgress$1.type = current$1;
								workInProgress$1 = updateContextProvider(null, workInProgress$1, renderLanes$1);
								break a;
							}
						}
						workInProgress$1 = "";
				...
				case 3:
					a: {
						...
						if (prevState.isDehydrated) if (prevState = {
							...
							for (workInProgress$1.child = renderLanes$1; renderLanes$1;) renderLanes$1.flags = renderLanes$1.flags & -3 | 134221824, renderLanes$1 = renderLanes$1.sibling;
						}
						else {
							resetHydrationState();
				...
				case 7: return returnFiber = workInProgress$1.pendingProps, markRef(current$1, workInProgress$1), reconcileChildren(current$1, workInProgress$1, returnFiber, renderLanes$1), workInProgress$1.child;
				...
				case 10: return updateContextProvider(current$1, workInProgress$1, renderLanes$1);
				...
				case 30: return null === workInProgress$1.stateNode && (workInProgress$1.stateNode = {
					autoName: null,
					paired: null,
					clones: null,
					ref: null
				}), returnFiber = workInProgress$1.pendingProps, null != returnFiber.name && "auto" !== returnFiber.name ? workInProgress$1.flags |= null === current$1 ? 18882560 : 18874368 : isHydrating && pushMaterializedTreeId(workInProgress$1), void 0 !== returnFiber.className && (prevSibling = "string" === typeof returnFiber.className ? JSON.stringify(returnFiber.className) : "{...}", didWarnAboutClassNameOnViewTransition[prevSibling] || (didWarnAboutClassNameOnViewTransition[prevSibling] = !0, console.error("<ViewTransition> doesn't accept a \"className\" prop. It has been renamed to \"default\".\n-   <ViewTransition className=%s>\n+   <ViewTransition default=%s>", prevSibling, prevSibling))), null !== current$1 && current$1.memoizedProps.name !== returnFiber.name ? workInProgress$1.flags |= 4194816 : markRef(current$1, workInProgress$1), reconcileChildren(current$1, workInProgress$1, returnFiber.children, renderLanes$1), workInProgress$1.child;
		...
		function preloadInstanceAndSuspendIfNeeded(workInProgress$1, type, oldProps, newProps, renderLanes$1) {
			var JSCompiler_temp;
			if (JSCompiler_temp = (workInProgress$1.mode & SuspenseyImagesMode) !== NoMode) JSCompiler_temp = null === oldProps ? maySuspendCommit(type, newProps) : maySuspendCommit(type, newProps) && (newProps.src !== oldProps.src || newProps.srcSet !== oldProps.srcSet);
			if (JSCompiler_temp) {
		...
		function completeWork(current$1, workInProgress$1, renderLanes$1) {
			...
			switch (workInProgress$1.tag) {
				...
				case 27:
					...
					if (null !== current$1 && null != workInProgress$1.stateNode) current$1.memoizedProps !== newProps && markUpdate(workInProgress$1);
						...
						if (!newProps) {
							...
							bubbleProperties(workInProgress$1);
							workInProgress$1.subtreeFlags &= -33554433;
							return null;
						}
				...
				case 13:
					...
					return null;
				case 4: return popHostContainer(workInProgress$1), null === current$1 && listenToAllSupportedEvents(workInProgress$1.stateNode.containerInfo), workInProgress$1.flags |= 67108864, bubbleProperties(workInProgress$1), null;
				case 10: return popProvider(workInProgress$1.type, workInProgress$1), bubbleProperties(workInProgress$1), null;
				case 19:
					popSuspenseListContext(workInProgress$1);
					newProps = workInProgress$1.memoizedState;
					...
					if (null === nextResource) if (type) cutOffTailIfNeeded(newProps, !1);
						...
						if (workInProgressRootExitStatus !== RootInProgress || null !== current$1 && 0 !== (current$1.flags & 128)) for (current$1 = workInProgress$1.child; null !== current$1;) {
							...
							if (null !== nextResource) {
								...
								pushSuspenseListContext(workInProgress$1, suspenseStackCursor.current & SubtreeSuspenseContextMask | ForceSuspenseFallback);
						...
						if (!type) if (current$1 = findFirstSuspended(nextResource), null !== current$1) {
							if (workInProgress$1.flags |= 128, type = !0, current$1 = current$1.updateQueue, workInProgress$1.updateQueue = current$1, scheduleRetryEffect(workInProgress$1, current$1), cutOffTailIfNeeded(newProps, !0), null === newProps.tail && "collapsed" !== newProps.tailMode && "visible" !== newProps.tailMode && !nextResource.alternate && !isHydrating) return bubbleProperties(workInProgress$1), null;
					...
					if (null !== newProps.tail) {
						current$1 = newProps.tail;
						a: {
							for (renderLanes$1 = current$1; null !== renderLanes$1;) {
								if (null !== renderLanes$1.alternate) {
									renderLanes$1 = !1;
									break a;
								}
						...
						newProps.rendering = current$1;
						newProps.tail = current$1.sibling;
						newProps.renderingStartTime = now$1();
						current$1.sibling = null;
						...
						"visible" === newProps.tailMode || "collapsed" === newProps.tailMode || !renderLanes$1 || isHydrating ? pushSuspenseListContext(workInProgress$1, nextResource) : (renderLanes$1 = nextResource, push(suspenseHandlerStackCursor, workInProgress$1, workInProgress$1), push(suspenseStackCursor, renderLanes$1, workInProgress$1), null === shellBoundary && (shellBoundary = workInProgress$1));
						isHydrating && pushTreeFork(workInProgress$1, newProps.treeForkCount);
						return current$1;
					}
					bubbleProperties(workInProgress$1);
				...
				case 25: return null;
				case 30: return workInProgress$1.flags |= 33554432, bubbleProperties(workInProgress$1), null;
			}
			throw Error("Unknown unit of work tag (" + workInProgress$1.tag + "). This error is likely caused by a bug in React. Please file an issue.");
		}
		function unwindWork(current$1, workInProgress$1) {
			...
			switch (workInProgress$1.tag) {
				...
				case 13:
					...
					current$1 = workInProgress$1.flags;
					return current$1 & 65536 ? (workInProgress$1.flags = current$1 & -65537 | 128, (workInProgress$1.mode & ProfileMode) !== NoMode && transferActualDuration(workInProgress$1), workInProgress$1) : null;
				case 19: return popSuspenseListContext(workInProgress$1), current$1 = workInProgress$1.flags, current$1 & 65536 ? (workInProgress$1.flags = current$1 & -65537 | 128, current$1 = workInProgress$1.memoizedState, null !== current$1 && (current$1.rendering = null, current$1.tail = null), workInProgress$1.flags |= 4, workInProgress$1) : null;
		...
		function safelyDetachRef(current$1, nearestMountedAncestor) {
			...
			if (null !== ref) if ("function" === typeof refCleanup) try {
				...
				captureCommitPhaseError(current$1, nearestMountedAncestor, error$8);
			}
		...
		function commitBeforeMutationEffects(root$1, firstChild, committedLanes) {
			...
			for (firstChild = committedLanes ? 9270 : 1024; null !== nextEffect;) {
				root$1 = nextEffect;
				if (committedLanes && (JSCompiler_temp = root$1.deletions, null !== JSCompiler_temp)) for (anchorOffset = 0; anchorOffset < JSCompiler_temp.length; anchorOffset++) committedLanes && commitExitViewTransitions(JSCompiler_temp[anchorOffset]);
				if (null === root$1.alternate && 0 !== (root$1.flags & 2)) committedLanes && trackEnterViewTransitions(root$1), commitBeforeMutationEffects_complete(committedLanes);
				else {
					if (22 === root$1.tag) {
						if (JSCompiler_temp = root$1.alternate, null !== root$1.memoizedState) {
							...
							committedLanes && trackEnterViewTransitions(root$1);
							commitBeforeMutationEffects_complete(committedLanes);
							continue;
						}
					}
					JSCompiler_temp = root$1.child;
					0 !== (root$1.subtreeFlags & firstChild) && null !== JSCompiler_temp ? (JSCompiler_temp.return = root$1, nextEffect = JSCompiler_temp) : (committedLanes && commitNestedViewTransitions(root$1), commitBeforeMutationEffects_complete(committedLanes));
				}
			}
		...
		function commitBeforeMutationEffects_complete(isViewTransitionEligible$jscomp$0) {
			for (; null !== nextEffect;) {
				var fiber = nextEffect, finishedWork = fiber, isViewTransitionEligible = isViewTransitionEligible$jscomp$0, current$1 = finishedWork.alternate, flags = finishedWork.flags;
				switch (finishedWork.tag) {
					case 0:
					case 11:
					case 15: break;
					case 1:
						0 !== (flags & 1024) && null !== current$1 && commitClassSnapshot(finishedWork, current$1);
						break;
					case 3:
						if (0 !== (flags & 1024)) {
					...
					case 17: break;
					case 30:
						isViewTransitionEligible && null !== current$1 && (isViewTransitionEligible = current$1, current$1 = finishedWork, finishedWork = getViewTransitionName(isViewTransitionEligible.memoizedProps, isViewTransitionEligible.stateNode), current$1 = current$1.memoizedProps, current$1 = getViewTransitionClassName(current$1.default, current$1.update), "none" !== current$1 && applyViewTransitionToHostInstances(isViewTransitionEligible, finishedWork, current$1, isViewTransitionEligible.memoizedState = [], !0));
						break;
		...
		function commitLayoutEffectOnFiber(finishedRoot, current$1, finishedWork) {
			...
			switch (finishedWork.tag) {
				...
				case 22:
					...
					if (!flags) {
						var newOffscreenSubtreeWasHidden = null !== current$1 && null !== current$1.memoizedState || offscreenSubtreeWasHidden;
						current$1 = offscreenSubtreeIsHidden;
						...
						offscreenSubtreeIsHidden = current$1;
		...
		function commitMutationEffectsOnFiber(finishedWork, root$1, lanes) {
			...
			switch (finishedWork.tag) {
				...
				case 14:
				case 15:
					if (flags & 4 && (current$1 = finishedWork.updateQueue, current$1 = null !== current$1 ? current$1.events : null, null !== current$1)) for (var ii = 0; ii < current$1.length; ii++) {
						var _eventPayloads$ii2 = current$1[ii];
						_eventPayloads$ii2.ref.impl = _eventPayloads$ii2.nextImpl;
					}
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
				...
				case 1:
					...
					flags & 64 && offscreenSubtreeIsHidden && (root$1 = finishedWork.updateQueue, null !== root$1 && (lanes = root$1.callbacks, null !== lanes && (flags = root$1.shared.hiddenCallbacks, root$1.shared.hiddenCallbacks = null === flags ? lanes : flags.concat(lanes))));
					break;
				case 26:
					...
					commitReconciliationEffects(finishedWork);
					flags & 512 && (offscreenSubtreeWasHidden || null === current$1 || safelyDetachRef(current$1, current$1.return));
					if (flags & 4) if (flags = null !== current$1 ? current$1.memoizedState : null, lanes = finishedWork.memoizedState, null === current$1) if (null === lanes) if (null === finishedWork.stateNode) if (offscreenSubtreeIsHidden) finishedWork.stateNode = createHoistableInstance(finishedWork.type, finishedWork.memoizedProps, root$1.containerInfo, finishedWork);
					else {
						a: {
							root$1 = finishedWork.type;
							lanes = finishedWork.memoizedProps;
							flags = ii.ownerDocument || ii;
							b: switch (root$1) {
								case "title":
									current$1 = flags.getElementsByTagName("title")[0];
									if (!current$1 || current$1[internalHoistableMarker] || current$1[internalInstanceKey] || current$1.namespaceURI === SVG_NAMESPACE || current$1.hasAttribute("itemprop")) current$1 = flags.createElement(root$1), flags.head.insertBefore(current$1, flags.querySelector("head > title"));
									setInitialProperties(current$1, root$1, lanes);
									current$1[internalInstanceKey] = finishedWork;
									markNodeAsHoistable(current$1);
									root$1 = current$1;
									break a;
								case "link":
									if (ii = getHydratableHoistableCache("link", "href", flags).get(root$1 + (lanes.href || ""))) {
										for (_eventPayloads$ii2 = 0; _eventPayloads$ii2 < ii.length; _eventPayloads$ii2++) if (current$1 = ii[_eventPayloads$ii2], current$1.getAttribute("href") === (null == lanes.href || "" === lanes.href ? null : lanes.href) && current$1.getAttribute("rel") === (null == lanes.rel ? null : lanes.rel) && current$1.getAttribute("title") === (null == lanes.title ? null : lanes.title) && current$1.getAttribute("crossorigin") === (null == lanes.crossOrigin ? null : lanes.crossOrigin)) {
											ii.splice(_eventPayloads$ii2, 1);
											break b;
										}
									}
									current$1 = flags.createElement(root$1);
									setInitialProperties(current$1, root$1, lanes);
									flags.head.appendChild(current$1);
									break;
								case "meta":
									if (ii = getHydratableHoistableCache("meta", "content", flags).get(root$1 + (lanes.content || ""))) {
										for (_eventPayloads$ii2 = 0; _eventPayloads$ii2 < ii.length; _eventPayloads$ii2++) if (current$1 = ii[_eventPayloads$ii2], checkAttributeStringCoercion(lanes.content, "content"), current$1.getAttribute("content") === (null == lanes.content ? null : "" + lanes.content) && current$1.getAttribute("name") === (null == lanes.name ? null : lanes.name) && current$1.getAttribute("property") === (null == lanes.property ? null : lanes.property) && current$1.getAttribute("http-equiv") === (null == lanes.httpEquiv ? null : lanes.httpEquiv) && current$1.getAttribute("charset") === (null == lanes.charSet ? null : lanes.charSet)) {
											ii.splice(_eventPayloads$ii2, 1);
											break b;
										}
									}
									...
									flags.head.appendChild(current$1);
									break;
								default: throw Error("getNodesForType encountered a type it did not expect: \"" + root$1 + "\". This is a bug in React.");
							}
							current$1[internalInstanceKey] = finishedWork;
							markNodeAsHoistable(current$1);
							root$1 = current$1;
						}
						finishedWork.stateNode = root$1;
					}
					...
					else flags !== lanes ? (null === flags ? (root$1 = current$1.stateNode, null === root$1 || offscreenSubtreeWasHidden || root$1.parentNode.removeChild(root$1)) : flags.count--, null === lanes ? offscreenSubtreeIsHidden || mountHoistable(ii, finishedWork.type, finishedWork.stateNode) : acquireResource(ii, lanes, finishedWork.memoizedProps)) : null === lanes && null !== finishedWork.stateNode && commitHostUpdate(finishedWork, finishedWork.memoizedProps, current$1.memoizedProps);
					break;
				case 27:
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
				...
				case 5:
					...
					if (finishedWork.flags & 32) {
						...
						try {
							runWithFiberInDEV(finishedWork, resetTextContent, root$1), viewTransitionMutationContext = !0;
						} catch (error) {
							captureCommitPhaseError(finishedWork, finishedWork.return, error);
						}
					}
				...
				case 6:
					...
					if (flags & 4) {
						...
						root$1 = finishedWork.memoizedProps;
						lanes = null !== current$1 ? current$1.memoizedProps : root$1;
						flags = finishedWork.stateNode;
						try {
							runWithFiberInDEV(finishedWork, commitTextUpdate, flags, lanes, root$1), viewTransitionMutationContext = !0;
						} catch (error) {
							captureCommitPhaseError(finishedWork, finishedWork.return, error);
						}
					}
				...
				case 3:
					...
					root$1.effectDuration += popNestedEffectDurations(ii);
					viewTransitionMutationContext = !1;
					break;
				case 4:
					flags = offscreenDirectParentIsHidden;
					offscreenDirectParentIsHidden = offscreenSubtreeIsHidden;
					current$1 = pushMutationContext();
					ii = currentHoistableRoot;
					...
					viewTransitionMutationContext = current$1;
				...
				case 31:
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
					flags & 4 && (root$1 = finishedWork.updateQueue, null !== root$1 && (finishedWork.updateQueue = null, attachSuspenseRetryListeners(finishedWork, root$1)));
					break;
				case 13:
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
				...
				case 22:
					...
					_eventPayloads$ii2 = null !== current$1 && null !== current$1.memoizedState;
					...
					commitReconciliationEffects(finishedWork);
					flags & 8192 && (root$1 = finishedWork.stateNode, root$1._visibility = ii ? root$1._visibility & ~OffscreenVisible : root$1._visibility | OffscreenVisible, !ii || null === current$1 || _eventPayloads$ii2 || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (root$1 = IncludeHostSingletons, lanes = _eventPayloads$ii2 || offscreenSubtreeWasHidden, current$1 = offscreenSubtreeIsHidden, _eventPayloads$ii2 = offscreenSubtreeWasHidden, offscreenSubtreeIsHidden = ii || offscreenSubtreeIsHidden, offscreenSubtreeWasHidden = lanes, recursivelyTraverseDisappearLayoutEffects(finishedWork, root$1), (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect"), offscreenSubtreeIsHidden = current$1, offscreenSubtreeWasHidden = _eventPayloads$ii2), !ii && offscreenDirectParentIsHidden || hideOrUnhideAllChildren(finishedWork, ii));
					flags & 4 && (root$1 = finishedWork.updateQueue, null !== root$1 && (lanes = root$1.retryQueue, null !== lanes && (root$1.retryQueue = null, attachSuspenseRetryListeners(finishedWork, lanes))));
					break;
				case 19:
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
				...
				case 30:
					...
					recursivelyTraverseMutationEffects(root$1, finishedWork, lanes);
					commitReconciliationEffects(finishedWork);
					_eventPayloads$ii2 && null !== current$1 && viewTransitionMutationContext && (finishedWork.flags |= 4);
					inUpdateViewTransition = ii;
					viewTransitionMutationContext = flags;
					break;
				case 21: break;
				case 7: flags & 512 && (offscreenSubtreeWasHidden || null === current$1 || safelyDetachRef(current$1, current$1.return)), current$1 && null !== current$1.stateNode && (current$1.stateNode._fragmentFiber = finishedWork);
				default: recursivelyTraverseMutationEffects(root$1, finishedWork, lanes), commitReconciliationEffects(finishedWork);
			}
			(finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && ((componentEffectSpawnedUpdate || .05 < componentEffectDuration) && logComponentEffect(finishedWork, componentEffectStartTime, componentEffectEndTime, componentEffectDuration, componentEffectErrors), null === finishedWork.alternate && null !== finishedWork.return && null !== finishedWork.return.alternate && .05 < componentEffectEndTime - componentEffectStartTime && (isHydratingParent(finishedWork.return.alternate, finishedWork.return) || logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Mount")));
			popComponentEffectStart(prevEffectStart);
			popComponentEffectDuration(prevEffectDuration);
		...
		function recursivelyTraverseAfterMutationEffects(root$1, parentFiber) {
			if (parentFiber.subtreeFlags & 9270) for (parentFiber = parentFiber.child; null !== parentFiber;) commitAfterMutationEffectsOnFiber(parentFiber, root$1), parentFiber = parentFiber.sibling;
			else measureNestedViewTransitions(parentFiber, !1);
		}
		function commitAfterMutationEffectsOnFiber(finishedWork, root$1) {
			var current$1 = finishedWork.alternate;
			if (null === current$1) commitEnterViewTransitions(finishedWork, !1);
			else switch (finishedWork.tag) {
				case 3:
					rootViewTransitionNameCanceled = viewTransitionContextChanged = !1;
					pushViewTransitionCancelableScope();
					recursivelyTraverseAfterMutationEffects(root$1, finishedWork);
					if (!viewTransitionContextChanged && !rootViewTransitionAffected) {
						finishedWork = viewTransitionCancelableChildren;
						if (null !== finishedWork) for (var i = 0; i < finishedWork.length; i += 3) {
							current$1 = finishedWork[i];
							var oldName = finishedWork[i + 1];
							restoreViewTransitionName(current$1, finishedWork[i + 2]);
							current$1 = current$1.ownerDocument.documentElement;
							null !== current$1 && current$1.animate({
								opacity: [0, 0],
						...
						finishedWork = root$1.containerInfo;
				...
				case 4:
					...
					break;
				case 22:
					null === finishedWork.memoizedState && (null !== current$1.memoizedState ? commitEnterViewTransitions(finishedWork, !1) : recursivelyTraverseAfterMutationEffects(root$1, finishedWork));
					break;
				case 30:
					i = viewTransitionContextChanged;
					...
					root$1 = getViewTransitionName(props, state);
					state = getViewTransitionName(current$1.memoizedProps, state);
					var className = getViewTransitionClassName(props.default, props.update);
					"none" === className ? root$1 = !1 : (props = current$1.memoizedState, current$1.memoizedState = null, current$1 = finishedWork.child, viewTransitionHostInstanceIdx = 0, root$1 = measureViewTransitionHostInstancesRecursive(finishedWork, current$1, root$1, state, className, props, !0), viewTransitionHostInstanceIdx !== (null === props ? 0 : props.length) && (finishedWork.flags |= 32));
					0 !== (finishedWork.flags & 4) && root$1 ? (scheduleViewTransitionEvent(finishedWork, finishedWork.memoizedProps.onUpdate), viewTransitionCancelableChildren = oldName) : null !== oldName && (oldName.push.apply(oldName, viewTransitionCancelableChildren), viewTransitionCancelableChildren = oldName);
					viewTransitionContextChanged = 0 !== (finishedWork.flags & 32) ? !0 : i;
					break;
				default: recursivelyTraverseAfterMutationEffects(root$1, finishedWork);
			}
		}
		...
		function reappearLayoutEffects(finishedRoot, current$1, finishedWork, layoutEffectTraversalFlags) {
		...
		function completeRootWhenReady(root$1, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
		...
		function markRootSuspended(root$1, suspendedLanes, spawnedLane, didAttemptEntireTree) {
			suspendedLanes = getEntangledLanes(root$1, suspendedLanes);
		...
		function prepareFreshStack(root$1, lanes) {
			...
			entangledRenderLanes = getEntangledLanes(root$1, lanes);
		...
		function renderRootConcurrent(root$1, lanes) {
			...
			a: do
				try {
					...
					handleThrow(root$1, thrownValue$10);
				}
			while (1);
			resetContextDependencies();
			ReactSharedInternals.H = prevDispatcher;
		...
		function completeRoot(root$1, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedState, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
			...
			if (null !== finishedWork) {
				...
				commitRoot(root$1, finishedWork, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, suspendedState, suspendedCommitReason, completedRenderEndTime);
			}
		}
		function commitRoot(root$1, finishedWork, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, suspendedState, suspendedCommitReason, completedRenderEndTime) {
			var remainingLanes = finishedWork.lanes | finishedWork.childLanes;
			pendingEffectsRemainingLanes = remainingLanes;
			remainingLanes |= concurrentlyUpdatedLanes;
			markRootFinished(root$1, lanes, remainingLanes, spawnedLane, updatedLanes, suspendedRetryLanes);
			pendingViewTransitionEvents = null;
			(lanes & 335544064) === lanes ? (pendingTransitionTypes = claimQueuedTransitionTypes(root$1), spawnedLane = 10262) : (pendingTransitionTypes = null, spawnedLane = 10256);
			0 !== finishedWork.actualDuration || 0 !== (finishedWork.subtreeFlags & spawnedLane) || 0 !== (finishedWork.flags & spawnedLane) ? (root$1.callbackNode = null, root$1.callbackPriority = 0, scheduleCallback$1(NormalPriority$1, function() {
			...
			if (pendingEffectsStatus === PENDING_MUTATION_PHASE) {
				...
				if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
					...
					try {
						...
						commitMutationEffectsOnFiber(finishedWork, root$1, lanes);
		...
		function pingSuspendedRoot(root$1, wakeable, pingedLanes) {
			...
			workInProgressRoot === root$1 && (workInProgressRootRenderLanes & pingedLanes) === pingedLanes && (workInProgressRootExitStatus === RootSuspendedWithDelay || workInProgressRootExitStatus === RootSuspended && (workInProgressRootRenderLanes & 62914560) === workInProgressRootRenderLanes && now$1() - globalMostRecentFallbackTime < FALLBACK_THROTTLE_MS ? (executionContext & RenderContext) === NoContext ? prepareFreshStack(root$1, 0) : workInProgressRootPingedLanes |= pingedLanes : workInProgressRootPingedLanes |= pingedLanes, workInProgressSuspendedRetryLanes === workInProgressRootRenderLanes && (workInProgressSuspendedRetryLanes = 0));
			ensureRootIsScheduled(root$1);
		}
		...
		function recursivelyTraverseAndDoubleInvokeEffectsInDEV(root$jscomp$0, parentFiber, isInStrictMode) {
			if (0 !== (parentFiber.subtreeFlags & 134225920)) for (parentFiber = parentFiber.child; null !== parentFiber;) {
				...
				22 !== fiber.tag ? fiber.flags & 134217728 ? isStrictModeFiber && runWithFiberInDEV(fiber, doubleInvokeEffectsOnFiber, root$1, fiber) : recursivelyTraverseAndDoubleInvokeEffectsInDEV(root$1, fiber, isStrictModeFiber) : null === fiber.memoizedState && (isStrictModeFiber && fiber.flags & 134225920 ? runWithFiberInDEV(fiber, doubleInvokeEffectsOnFiber, root$1, fiber) : fiber.subtreeFlags & 134217728 && runWithFiberInDEV(fiber, recursivelyTraverseAndDoubleInvokeEffectsInDEV, root$1, fiber, isStrictModeFiber));
				parentFiber = parentFiber.sibling;
			}
		}
		function doubleInvokeEffectsOnFiber(root$1, fiber) {
			setIsStrictModeForDevtools(!0);
			try {
				disappearLayoutEffects(fiber, NoLayoutEffectTraversalFlags), disconnectPassiveEffect(fiber), reappearLayoutEffects(root$1, fiber.alternate, fiber, NoLayoutEffectTraversalFlags), reconnectPassiveEffects(root$1, fiber, 0, null, !1, 0);
			} finally {
				setIsStrictModeForDevtools(!1);
			}
		}
		...
		function getStylesObjectFromElement(domElement) {
			for (var serverValueInObjectForm = {}, style$1 = domElement.style, i = 0; i < style$1.length; i++) {
				var styleName = style$1[i];
				"view-transition-name" === styleName && isExpectedViewTransitionName(domElement) || (serverValueInObjectForm[styleName] = style$1.getPropertyValue(styleName));
			}
		...
		function blurActiveElementWithinFragment(child, activeElement$2) {
			if (6 === child.tag) return !1;
			child = getInstanceFromHostFiber(child);
			return child === activeElement$2 || child.contains(activeElement$2) ? (activeElement$2.blur(), !0) : !1;
		}
